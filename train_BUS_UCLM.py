...
from configs.loss import CombinedLoss,SSIMLoss,  BCEDiceLoss, DiceLoss_T, DiceLoss_v,dice_coefficient, plot_losses, plot_losses_2,plot_losses_pros
import torch.nn.functional as F
from denoising_diffusion import GaussianDiffusion, GaussianDiffusion_att, DDIMDiffusion
from U_net import UNetb, UNets,AttentionResUNet,SwinUnet
...
"""
weights/2025-05-10_21-39-40_FullPipeline/unet/unet_only/best_model.pth/epoch_28_best_model.pth
"""
...
def train_diffusion(args, device,sub_module=None):
    ...
    for epoch in range(args.epochs):
        ...
        if (epoch + 1) % 1 == 0:
            with torch.no_grad():
                gen_vis = diffusion_model(sample_images)[1]
                for i in range(4):
